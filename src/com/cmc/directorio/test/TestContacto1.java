...
public class TestContacto1 {
	...
	public static void main(String[] args) {
		Telefono telef = new Telefono("movi", "098745632", 78);
		Contacto c = new Contacto("Arturo", "Perez", telef, 2.2);
		...
		Contacto c2 = new Contacto("Juan", "Lopez", telef2, 40.0);
		...
		Contacto c3 = new Contacto("Marco", "Ramirez", telef3, 70.0);
